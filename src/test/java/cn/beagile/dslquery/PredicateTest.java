...
class PredicateTest {
    ...
    public void should_throw_exception_when_field_not_start_with_letter() {
        RuntimeException e = assertThrows(RuntimeException.class, () -> new Predicate("1name", "equal", "bob"));
    ...
    public void should_throw_exception_when_field_contains_not_letter_number_underline() {
        RuntimeException e = assertThrows(RuntimeException.class, () -> new Predicate("na%me", "equal", "bob"));
